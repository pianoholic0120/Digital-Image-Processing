...
public:
	...
	// Export point cloud to vectors (points in world coordinates)
	void exportPointCloud(std::vector<Eigen::Vector3f>& points, std::vector<Eigen::Vector3f>& colors, 
	                     float scaledTH = 1e10, float absTH = 1e10, int mode = 1, float minBS = 0, int sparsity = 1);
