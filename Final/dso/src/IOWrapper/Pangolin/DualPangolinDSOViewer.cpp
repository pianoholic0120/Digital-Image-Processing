...
void DualPangolinDSOViewer::pushLiveFrame(FrameHessian* image)
{
    ...
    try {
        ...
        if(image->dI != nullptr && targetImg != nullptr && targetImg->data != nullptr) {
